	...
	.then(
		function(){
			...
			if(Object.keys(aData).indexOf(firebase.auth().currentUser.uid)>=0){
				...
				setTimeout(function(){eId('spacer').innerHTML="";},4500);
				a=false;
